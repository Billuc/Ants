...
import ContrastMaterial from '../materials/ContrastMaterial';

/**
 * Bloom pass based on contrast
 * Inspired by UnrealBloomPass : https://github.com/mrdoob/three.js/blob/r138/examples/jsm/postprocessing/UnrealBloomPass.js
 */
export class ContrastBloomPass extends Pass {
	// Consts
	...
	contrastMaterial: ShaderMaterial;
	...
	constructor(resolution: Vector2, strength: number, radius: number) {
		super();
		...
		this.contrastMaterial = new ContrastMaterial();
	...
	override render(
		...
		this.contrastMaterial.uniforms[ 'tDiffuse' ].value = readBuffer.texture;
		this.contrastMaterial.uniforms[ 'texSize' ].value = new Vector2(
			readBuffer.width, readBuffer.height
		);
		this.fsQuad.material = this.contrastMaterial;
